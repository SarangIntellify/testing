package com.amazonaws.lambda.steppolling;
...
public class Service {
	...
	public String polling() {
		...
		try {
		 ...
		 request.setActivityArn("arn:aws:states:us-west-2:987450053827:activity:ManualIndividualActivity");
		 request.setWorkerName("Sarang");
